...
const examples = [
  {
    ...
    steps: [
      ...
      { title: "Increase height with variation", actor: "USER", intent: "Make the curves gradually taller from left to right, with some randomness in their heights and widths.", operation: "update_parameter(data_function)", change: "scale_y → (index / total_count + random() + 0.2) / 2; scale_x → 0.2 + Math.random() * (1.4 - 0.5).", explanation: "The index term creates the rising trend, while random terms keep both height and width from looking uniform.", dsl: {}, view: { count: 20, stems: true, data: true } },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "Paste country names", actor: "USER", intent: "Add these country names beside the completed glyphs: India, Canada, England, Australia, Japan, Germany, France, Brazil.", operation: "paste_data + bind_text + stick_to", change: "Mexico.text_content → ['India', 'Canada', 'England', 'Australia', 'Japan', 'Germany', 'France', 'Brazil'][index]; attach label → Vector 166.top.", explanation: "The eight names are pasted into the text mapping in repeat order, then each generated label is attached beside its corresponding line.", dsl: {}, view: { count: 8, data: true, labels: true } }
    ]
  },
  {
